...
long_description IO.read(File.join(File.dirname(__FILE__), 'README.mk'))
version          "1.0.0"
...
recipe "phpdevtools", "Installs and configures tools for doing PHP development (e.g., PHPUnit)."
